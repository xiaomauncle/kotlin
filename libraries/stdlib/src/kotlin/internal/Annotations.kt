 ...
 *
 * The Kotlin compiler of an earlier version (or a new compiler with the old -language-version) is going to report a diagnostic
 * on usages of this declaration. The diagnostic message can be specified with [message], or via [errorCode] (takes less space,
